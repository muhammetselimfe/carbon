...
Avatar is a decentralized marketplace for carbon credits.
It is a platform for the issuance, trading, and management of carbon credits. 
            </p>
            <ul className="text-gray">
              <li className="mb-4 w-fill flex">
              <svg xmlns="http://www.w3.org/2000/svg" className="flex-none w-6 h-full w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
<span className="ml-2">Collateralized Carbon Credit Exchange</span>
                </li>
                <li className="mb-4 w-fill flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-none w-6 h-full w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
